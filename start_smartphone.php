...
if (isset ($_SESSION['inloggad']))
	...
	{
		echo "Don't have a useraccount? <a href='createuser_smartphone.php'>Create one</a><br>Already user?<a href='login_smartphone.php'>Login</a>";
		die();
	}
...
<br>
<a href="post_smartphone.php"><h2>Post something</h2></a>
<a href="logout_smartphone.php"><h2>Log out</h2></a>
							<!-- end of form -->
<div id="content">
...
$n = 0;
 while ( $row = mysqli_fetch_assoc($res) ) /* om variablarna stämmer så skrivs detta ut och mysqli_fetch_assoc hämtar rader*/
 {
 	...
 	echo "<form action='deletepost_smartphone.php' method='get'>
